     ...
     <nav class="header center">
        ...
        <div class="blog-content center" id="blog-details">
            <div class="blog__details">
                ...
                <articleComp v-for="(article,index) in articleList" :key="index" :article="article"></articleComp>
                ...
                <article class="blog__details_articles">
                    ...
                    <ol class="article_list">
                        <li class="blog__details_text">Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.</li>
                        <li class="blog__details_text">Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.</li>
                        <li class="blog__details_text">Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.</li>
                    </ol>
                    <img class="blog__details_img" src="@/assets/img/blog_details/article_end.png" alt="article_end photo">
                    <p class="blog__details_text">Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae turpmaximus.posuere in.Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.</p>
                </article>
            </div>
            <div class="sidebar">
                <h4 class="sidebar_title">Tags</h4>
                <div class="sidebar__tags">
                    <div class="sidebar__tags_block">
                        <button @click="sortTagName('kitchen')" class="sidebar__tag_button">Kitchen</button>
                        <button @click="sortTagName('bedroom')" class="sidebar__tag_button">Bedroom</button>
                    </div>
                    <div class="sidebar__tags_block">
                        <button @click="sortTagName('building')" class="sidebar__tag_button">Building</button>
                        <button @click="sortTagName('architecture')" class="sidebar__tag_button">Architecture</button>
                    </div>
                    <div class="sidebar__tags_block">
                        <button @click="sortTagName('kitchen planning')" class="sidebar__tag_button">Kitchen Planning</button>
                        <button @click="sortTagName('bedroom')"  class="sidebar__tag_button">Bedroom</button>
                    </div>
                </div>
            </div>
        ...
        <div class="footer center">
            ...
            <div class="pages">
                ...
                <ul class="footer__nav">
                    ...
                    <li class="footer__nav_link">
                        <a href="#" class="footer__text">Project</a>
                    </li>
                    <li class="footer__nav_link">
            ...
            methods: {
                sortTagName(tag){
                    ...
                    this.articleList.forEach(article => {
                        if (article.tag===tag){
                            this.articleList.splice(count, 1);
                            this.articleList.splice(0,0,article);
                        }
                        count++;
                    })
                }
